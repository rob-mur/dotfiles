{
  ...
  # Yuzu
  home-manager.users.rob.home = {
    packages = with pkgs; [yuzu-pkgs.yuzu];
    sessionVariables = {
  ...
  # Disable lock screen and sleep for desktop
  home-manager.users.rob.services.swayidle.enable = lib.mkForce false;
